...
- На широком окне подключение и маршруты расположены рядом. На узком окне
  и при увеличенном тексте блоки перестраиваются; маршруты можно свернуть.
- Сохранены разделы «Сервисы», «Источники VPN» и «Стратегии», поиск и
  закрепление сервисов. Расширенные инструменты находятся в настройках.
...
- Сетевой движок, политики сервисов и VPN-источники не изменены. Существующие
  подписки и настройки сохраняются. Android сохраняет прежний интерфейс.
...
обновлении старой версии до 3.0.29. Не запускайте две версии одновременно.
