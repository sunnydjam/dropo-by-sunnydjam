...
| Windows release fork | `v3.0.26`, unsigned |
...
В версии `3.0.26` для Discord рекомендуется `Через VPN`. Встроенный Zapret
...
[`v3.0.26`](https://github.com/sunnydjam/dropo-by-sunnydjam/releases/tag/v3.0.26).
