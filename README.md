...
| Windows release fork | `v3.0.28`, unsigned |
...
На главной — подключение, источник, два режима и сворачиваемые быстрые маршруты.
...
Из общих настроек убран дублирующий редактор маршрутов. Подробности:
...
В версии `3.0.28` для Discord рекомендуется `Через VPN`. Встроенный Zapret
...
[`v3.0.28`](https://github.com/sunnydjam/dropo-by-sunnydjam/releases/tag/v3.0.28).
...
обновление поверх текущей установки и перезапускается. Эту функцию можно
