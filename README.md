...
| Публично подписанный релиз fork | Пока не опубликован |
...
Публичный релиз `Dropo by sunnydjam` пока не опубликован. Не выдавайте сборки
upstream за сборки этого fork и не скачивайте исполняемые файлы из случайных
источников.

Будущий Windows-релиз будет содержать:
