...
| Windows release fork | `v3.0.30`, unsigned |
...
Сетевой движок этим обновлением не меняется. Android-пакет не входит в выпуск.
...
В версии `3.0.30` для Discord рекомендуется `Через VPN`. Встроенный Zapret
...
[`v3.0.30`](https://github.com/sunnydjam/dropo-by-sunnydjam/releases/tag/v3.0.30).
