...
| Windows release fork | `v3.0.27`, unsigned |
...
В версии `3.0.27` для Discord рекомендуется `Через VPN`. Встроенный Zapret
...
[`v3.0.27`](https://github.com/sunnydjam/dropo-by-sunnydjam/releases/tag/v3.0.27).
